...
###########################################################################################
# === Please modify the following paths and knobs according to your environment ===
Framework_name=QwenGR00TImplicitCoT
freeze_module_list=''
base_vlm=./playground/Pretrained_models/Qwen3-VL-4B-Instruct-Action
config_yaml=./starVLA/config/training/starvla_bridge_latent_cot.yaml
...
run_id=implicit_cot_${data_mix}_qwen3vl4b
wandb_project=starVLA_implicit_cot
