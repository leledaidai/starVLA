...
config_yaml=./starVLA/config/training/train_latent_vla/starvla_bridge_latent_cot_full_loss_vlm_prompt.yaml
...
run_id=latent_cot_full_loss_vlm_prompt_${data_mix}_qwen3vl4b
