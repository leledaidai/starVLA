...
config_yaml=./starVLA/config/training/train_latent_vla/starvla_bridge_latent_cot_disitll_off_test_vlm_prompt.yaml
...
run_id=latent_cot_distill_off_test_${data_mix}_qwen3vl4b_test_bs16_vlm_prompt
