...
config_yaml=./starVLA/config/training/starvla_bridge_latent_cot_small_fit_distill_off.yaml
...
run_id=implicit_cot_small_fit_distill_off_${data_mix}_qwen3vl4b
wandb_project=starVLA_implicit_cot_small_fit_distill_off
...
python starVLA/training/eval_cot_small_fit.py \
  ...
  --output_path ${output_dir}/small_fit_eval_distill_off.json \
  --summary_jsonl ${output_dir}/small_fit_eval_distill_off_results.jsonl \
  --run_root_dir ${run_root_dir} \
  --run_id ${run_id} \
  --datasets.vla_data.data_root_dir ${oxe_data_root} \
  --datasets.vla_data.data_mix ${data_mix} \
