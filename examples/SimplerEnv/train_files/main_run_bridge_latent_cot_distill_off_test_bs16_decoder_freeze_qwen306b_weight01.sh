...
decoder_model_path=./playground/Pretrained_models/Qwen3-0.6B
...
run_id=latent_cot_distill_off_test_${data_mix}_qwen3vl4b_test_bs16_new_55_decoder_freeze_qwen306b_weight01
