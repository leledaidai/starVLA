...
config_yaml=./starVLA/config/training/train_latent_vla/starvla_bridge_latent_cot_full_loss_codi.yaml
...
run_id=full_loss_codi_new_${data_mix}_qwen3vl4b_bs8_fields_3
