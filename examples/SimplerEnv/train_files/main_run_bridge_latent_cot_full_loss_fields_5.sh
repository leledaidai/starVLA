...
config_yaml=./starVLA/config/training/train_latent_vla/starvla_bridge_latent_cot_full_loss_fields_5.yaml
...
run_id=latent_cot_full_loss_${data_mix}_qwen3vl4b_fields_5
