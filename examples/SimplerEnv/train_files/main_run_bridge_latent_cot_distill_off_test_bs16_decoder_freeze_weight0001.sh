...
run_id=latent_cot_distill_off_test_${data_mix}_qwen3vl4b_test_bs16_new_55_decoder_freeze_weight_0001
...
accelerate launch \
  ...
  --cot.decoder_loss_weight "${decoder_loss_weight}" \
