...
config_yaml=./starVLA/config/training/train_latent_vla/starvla_bridge_latent_cot_full_loss_513try.yaml
...
run_id=latent_cot_full_loss_${data_mix}_qwen3vl4b_multinode_513try
